...
class SlurmRESTAPIHandler(APIHandler):
    @web.authenticated
    def post(self):
        ...
        self.finish(json.dumps({"message": "SlurmRESTAPI data configured"}))
        self.set_status(201)


default_handlers.append((r"/api/slurmrestapi", SlurmRESTAPIHandler))
